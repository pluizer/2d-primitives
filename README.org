A toolbox with an extensive list of primitives and functions related to linear algebra for Chicken Scheme. Useful for 2d physics, graphics, games etc. Used o.a. in my game engine [[https://github.com/pluizer/coati-2d][Coati]].
